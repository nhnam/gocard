...
@property (nonatomic, strong) id <MaskedTextFieldDelegateListener> _Nullable listener;
...
*/
- (NSInteger)acceptableTextLength;
/**
  Maximal length of the text inside the field.
...
*/
- (NSInteger)acceptableValueLength;
/**
...
/**
  ...
  Allows assigning \code
  MaskedTextFieldDelegate.listener
  \endcode within the Interface Builder.
  Consider using \code
  MaskedTextFieldDelegate.listener
  \endcode property from your source code instead of
  \code
...
@interface PolyMaskTextFieldDelegate (SWIFT_EXTENSION(InputMask))
@end
